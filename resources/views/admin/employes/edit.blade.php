...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <strong class="card-title">Edit Employe</strong>
        </div>
        <div class="card-body">
            <!-- Credit Card -->
            <div id="pay-invoice">
                <div class="card-body">
                    <hr>
                    <form action="{{ route('employes.update',$employe->id)}}" method="post" novalidate="" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input  name="first_name" type="text" class="form-control"  value="{{ $employe->first_name }}" required>
                                    @error('first_name')
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control" type="text" id="" name="last_name" value="{{ $employe->last_name }}" required>
                                @error('last_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-6">
                                ...
                                <select id="company_id" class="form-control js-example-basic-single" name="company_id" required>
                                    ...
                                    @foreach($companies as $company)
                                        <option value="{{ $company->id }}" {{ $employe->company_id == $company->id ? 'selected' : '' }}>
                                            {{ $company->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control" type="text" id="" name="email" value="{{ $employe->email }}">
                                @error('email')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="col-6" style="margin-top: 10px">
                                ...
                                <input class="form-control" type="text" id="" name="phone" value="{{ $employe->phone }}">
                                @error('phone')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
